...
Data <- read.csv("F:/6. EXPLORATION/2. R/GermanCredit.csv", sep = ",", header = T)
head(Data)
...
#confusionMatrix(testData$Class1, PRED_LOG)
#ROCRpred <- prediction(as.numeric(PRED_LOG), as.numeric(testData$Class1))
